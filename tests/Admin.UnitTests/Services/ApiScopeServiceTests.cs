...
public class ApiScopeServiceTests
{
    ...
    private static IApiScopeService GetApiScopeService(IApiScopeRepository repository, IApiScopeServiceResources resources, IAuditEventLogger auditEventLogger)
    {
